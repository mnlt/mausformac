          ...
          <div className="hero">
            ...
            <div className="ctas desktop-only">
              <div className="cta-group">
                <a href="/maus/releases/Maus-1.5.3.dmg" className="cta-button primary">
        ...
        <section className="testimonials-section">
          ...
          <div className="testimonials-grid">
            ...
            <div className="testimonial-card">
              ...
              <p className="testimonial-text">
                "You're so fast! And the implementation is fantastic! So intuitive."
              </p>
            </div>
        ...
        <section className="pricing-section">
          ...
          <div className="pricing-cards">
            ...
            <div className="pricing-card">
              ...
              <a href="/maus/releases/Maus-1.5.4.dmg" className="cta-button primary">
